...
把外部契约参考从临时意见升级为可追溯上下文。最终 disposition 由 {{JARVIS_PURPOSE}} 已确认产品范围和客户证据决定。
