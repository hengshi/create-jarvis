...
7. automatically coordinates Company construction and Repository learning;
8. continues through reconciliation and workflow construction;
9. stops only for real authorization, business ambiguity, Git approval, unavailable future shadow evidence, or an external blocker;
10. invokes formal jarvis-box deployment only when the content boundary is ready.
